...
namespace HebrewDate.Service
{
    internal class DateConvertService
    {
        ...
        {
            List<string> days = ["באחד", "בשני", "בשלישי ", "ברביעי", "בחמישי", "בששי"];
            return days[day]+" בשבת ";
        }
        ...
        public static string ConvertDayMonth(int dayMonth, int imonth)
        {
            ...
            List<string> dayMonths = ["יום אחד", "שני ימים", "שלשה ימים", "ארבעה ימים", "חמישה ימים", "ששה ימים", "שבעה ימים", "שמונה ימים", "תשעה ימים", "עשרה ימים", "אחד עשר יום", "שנים עשר יום", "שלשה עשר יום", "ארבעה עשר יום", "חמשה עשר יום", "ששה עשר יום", "שבעה עשר יום", "שמונה עשר יום", "תשעה עשר יום", "עשרים יום", "אחד ועשרים יום", "שנים ועשרים יום", "שלשה ועשרים יום", "ארבעה ועשרים יום", "חמשה ועשרים יום", "ששה ועשרים יום", "שבעה ועשרים יום", "שמונה ועשרים יום", "תשעה ועשרים יום"];
        ...
        {
            List<string> years = ["שמנים וארבע", "שמנים וחמש", "שמנים ושש", "שמנים ושבע", "שמנים ושמונה", "שמנים ותשע", "תשעים", "תשעים ואחת", "תשעים ושתיים", "תשעים ושלוש"];
            return " שנת חמשת אלפים ו" + years[year] + " לבריאת העולם";
        }
